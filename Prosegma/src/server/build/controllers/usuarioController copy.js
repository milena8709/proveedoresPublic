...
class UsuarioController {
    ...
    saveCuenta(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.default.query('INSERT INTO usuarios (usuario, clave, idperfil, id_proveedor, correo, nombres, apellidos) values ("' + req.body.nit + '", "' + req.body.clave + '","' + req.body.perfil + '" , "' + req.body.nit + '", "' + req.body.correo + '")');
